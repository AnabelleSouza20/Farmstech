      ...
      <Grid container spacing={1}>
        ...
        >
          ...
          >
            ...
            <MenuItem onClick={handleClose2}><a href="/mapa" className="a-not-effect">Mapas</a></MenuItem>
            <MenuItem onClick={handleClose2}><a href="/ativos" className="a-not-effect">Ativos</a></MenuItem>
            <MenuItem onClick={handleClose2}><a href="/grupos" className="a-not-effect">Grupos</a></MenuItem>
      ...
      <div className="descHome">
        ...
        >
          ...
          <Grid item xs={8}>
            ...
            <Grid item xs={12}>
              <h4 className="desc">
                Conectar os ativos por forma remota <br />
                controlando sua iniciação e desligamento.
              </h4>
            </Grid>
          </Grid>
        </Grid>
        <div className="descLazer">
          ...
          >
            ...
            <Grid item xs={8}>
              ...
              <Grid item xs={12}>
                <h4 className="desc">
                  Controlar iluminação de ativos, banheiros <br />e
                  churrasqueira.
                </h4>
              </Grid>
            </Grid>
